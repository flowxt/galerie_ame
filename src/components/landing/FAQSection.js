        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Link
              ...
              className="group glass-card rounded-3xl p-8 border border-rose-200/50 hover-lift shadow-soft hover:shadow-elegant transition-all duration-500"
            >
            ...
            <Link
              ...
              className="group glass-card rounded-3xl p-8 border border-blue-200/50 hover-lift shadow-soft hover:shadow-elegant transition-all duration-500"
            >
            ...
            <Link
              href="/attrape-reves"
              className="group glass-card rounded-3xl p-8 border border-purple-200/50 hover-lift shadow-soft hover:shadow-elegant transition-all duration-500"
            >
