...
import TableauDeVieOrderForm from "./TableauDeVieOrderForm";

export default function TableauDeVieOrderModal({
  isOpen,
  onClose,
  selectedFormat,
}) {
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-4xl max-h-[90vh] overflow-y-auto bg-white rounded-3xl shadow-2xl">
        ...
        <div className="p-8 md:p-12">
          ...
          >
            <TableauDeVieOrderForm preselectedFormat={selectedFormat} />
          </Suspense>
        </div>
      </div>
    </div>
